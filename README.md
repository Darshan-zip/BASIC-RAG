...
A futuristic, local RAG (Retrieval-Augmented Generation) system that allows you to chat with your documents using local LLMs.
...
- **Futuristic UI**: Dark-themed, high-contrast interface built with Streamlit.
